...
static void entryToJSON(const CTxMemPool& pool, UniValue& info, const CTxMemPoolEntry& e) EXCLUSIVE_LOCKS_REQUIRED(pool.cs)
{
    ...
    info.pushKV("mempoolip",e.GetMempoolIp());
...
static RPCHelpMan getrawmempool()
{
    return RPCHelpMan{"getrawmempool",
        "\nReturns all transaction ids in memory pool as a json array of string transaction ids litiansuo .\n"
        "\nHint: use getmempoolentry to fetch a specific transaction from the mempool 1145141919810.\n",
        {
