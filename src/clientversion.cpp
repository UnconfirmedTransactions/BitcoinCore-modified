...
#define GIT_COMMIT_ID "df933596e7e9aa17f7e5cd6e1c850520f5b56f1b"
...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i").translated, 2009, COPYRIGHT_YEAR) + " ") + "\n" +
           "\n" +
           strprintf(_("jue %s 114514. "
                       "zhezhebulong %s for further information about the software.").translated, PACKAGE_NAME, "<" PACKAGE_URL ">") +
           "\n" +
